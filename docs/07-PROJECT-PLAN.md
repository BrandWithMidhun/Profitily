...
| TASK-004 | `apps/api` NestJS skeleton: health route, Prisma module, **tenant guard**, error/logging middleware, OTel init. | `/health` 200; **tenant-isolation unit test** proves unscoped query is rejected. | REVIEW |
