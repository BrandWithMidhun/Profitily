...
|---|---|---|---|
| TASK-001 | Monorepo (pnpm+Turborepo), `packages/config` (eslint+security, tsconfig, prettier, **vitest preset**), root scripts. | `pnpm install/lint/typecheck/build` pass on empty workspace; `pnpm test` runs (0 tests OK). | TODO |
